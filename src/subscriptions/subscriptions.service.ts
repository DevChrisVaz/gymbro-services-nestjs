...
import { ISubscription, SerializedSubscription, Subscription } from './domain/entities/subscription.entity';

@Injectable()
export class SubscriptionsService {

  mapDtoToSubscription(dto: CreateSubscriptionDto | UpdateSubscriptionDto): ISubscription {
