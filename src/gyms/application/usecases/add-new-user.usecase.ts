...
export class AddNewUserUseCase {
    ...
    async run(addNewUserDTO: AddNewUserDto): Promise<GYMUserResponseDTO> {
        ...
        const createdGYMUser: IGYMUser = await this.databaseServices.GYMUsers.save(gymUser);
        ...
        return {
            ...this.usersService.serializeUser(createdUser),
            ...this.gymsService.serializeGYMUser(createdGYMUser)
        }
    }
}