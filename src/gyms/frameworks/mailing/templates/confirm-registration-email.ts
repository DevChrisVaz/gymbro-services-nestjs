...
const confirmRegistration = (person: IPerson) => {
  return `
    <!DOCTYPE html
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <p class="mailbody">Hola, ${person.firstName}. Gracias por
                                                                registrarte a la comunidad de gimnasios GYMBRO, ahora evaluaremos 
                                                                tu información y activaremos tu cuenta.
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <p
                                                                ...
                                                                Por ahora es todo, nuestro equipo se encargará del resto y te
                                                                notificaremos el proceso haya terminado.
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </table>
